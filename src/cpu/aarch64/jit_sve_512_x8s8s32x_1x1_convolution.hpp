...
#ifndef CPU_AARCH64_JIT_SVE512_CORE_X8S8S32X_1X1_CONVOLUTION_HPP
#define CPU_AARCH64_JIT_SVE512_CORE_X8S8S32X_1X1_CONVOLUTION_HPP
...
struct jit_sve_512_x8s8s32x_1x1_convolution_fwd_t : public primitive_t {
    struct pd_t : public cpu_convolution_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T(JIT_IMPL_NAME_HELPER("jit_int8_1x1:", sve_512, ""),
                jit_sve_512_x8s8s32x_1x1_convolution_fwd_t);
        ...
        status_t init(engine_t *engine) {
            ...
            jit_sve_512_x8s8s32x_1x1_conv_kernel::init_scratchpad(
        ...
        using dw_pd_t =
                typename jit_sve_512_x8s8s32x_convolution_fwd_t<sdt, ddt>::pd_t;
...
#undef CASE
    ...
    jit_sve_512_x8s8s32x_1x1_convolution_fwd_t(const pd_t *apd)
        : primitive_t(apd) {}
    ...
    status_t init(engine_t *engine) override {
        CHECK(safe_ptr_assign(kernel_,
                new jit_sve_512_x8s8s32x_1x1_conv_kernel(
                        pd()->jcp_, *pd()->attr())));
...
private:
    ...
    std::unique_ptr<jit_sve_512_x8s8s32x_1x1_conv_kernel> kernel_;
    std::unique_ptr<rtus_driver_t<sve_512>> rtus_driver_;
    using dw_conv_kernel_t = jit_sve_512_x8s8s32x_fwd_kernel;

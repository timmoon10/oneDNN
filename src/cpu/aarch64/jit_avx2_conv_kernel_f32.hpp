...
#ifndef CPU_AARCH64_JIT_AVX2_CONV_KERNEL_F32_HPP
#define CPU_AARCH64_JIT_AVX2_CONV_KERNEL_F32_HPP
...
private:
    ...
    reg64_t aux_reg_ker_d = abi_not_param1_x64;
    ...
    reg64_t reg_kh = abi_not_param1_x64;
...
private:
    ...
    reg64_t aux_reg_kernel_oc_loop = abi_not_param1_x64; /* used in ndims < 5
                                                        case only */

    reg64_t aux_reg_dst_d = r12; // used in ndims == 5 case only
    reg64_t aux_reg_ker_d = r14; // used in ndims == 5 case only

    reg64_t reg_ki = abi_not_param1_x64; // used in ndims == 5 case only
    reg64_t kj = r11;
    reg64_t oi_iter = r12;
    reg64_t reg_kh = r14;
...
private:
    ...
    reg64_t reg_kernel = rdx;
    reg64_t reg_output = rsi;
    reg64_t b_ic = abi_not_param1_x64;
    reg64_t kj = r8;
    reg64_t reg_kh = r9;

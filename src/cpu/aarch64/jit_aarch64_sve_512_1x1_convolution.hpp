...
struct jit_aarch64_sve_512_1x1_convolution_fwd_t : public primitive_t {
    ...
    jit_aarch64_sve_512_1x1_convolution_fwd_t(const pd_t *apd)
        : primitive_t(apd) {}
...
struct jit_aarch64_sve_512_1x1_convolution_bwd_data_t : public primitive_t {
